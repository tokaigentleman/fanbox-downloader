...
class n {
    ...
    countPost() {
        return Object.values(this.downloadObj.posts).reduce(((e, t) => e + t.length), 0)
    }
    countFile() {
        return Object.values(this.downloadObj.posts).reduce(((e, t) => e + t.reduce(((e, t) => e + Object.values(t.files).reduce(((e, t) => e + t.length), 0)), 0)), 0)
    }
    collectTags() {
        const e = new Set;
        return Object.values(this.downloadObj.posts).forEach((t => t.forEach((t => t.tags.forEach((t => e.add(t))))))), [...e]
    }
}
class o {
    constructor(e, t) {
    ...
    getCurrentFilePath(e) {
        ...
        if (void 0 === this.postObj.files[t]) throw new Error(`file object is undefined: ${e.getOriginalName()}`);
        const n = this.postObj.files[t].findIndex((t => e.equals(t)));
        if (n < 0) throw new Error(`file object is not found: ${e.getOriginalName()}`);
        const o = this.utils.getFileName(t, e.getEncodedExtension(), this.postObj.files[t].length, n, !0);
    ...
    toJsonObjBy(e) {
        ...
        if (void 0 === o || o < 0) throw new Error(`post object is not found: ${this.postObj.name}`);
        const s = this.utils.getFileName(n, "", e[n].length, o, !1),
            i = this.postObj.cover ? {
                url: this.postObj.cover.url,
                name: this.utils.getFileName(this.postObj.cover.name, this.postObj.cover.extension, 1, 0, !0)
            } : void 0;
        return {
...
class s {
    ...
    equals(e) {
        return "object" == typeof e && e.name === this.fileObj.name && e.url === this.fileObj.url
    }
}
class i {
    constructor(e) {
    ...
    async createDownloadUI(e) {
        document.head.innerHTML = "", document.body.innerHTML = "", document.getElementsByTagName("html")[0].style.height = "100%", document.body.style.height = "100%", document.body.style.margin = "0", document.title = e;
        let t = document.createElement("link");
        t.href = this.bootCSS.href, t.rel = "stylesheet", t.integrity = this.bootCSS.integrity, t.crossOrigin = "anonymous", document.head.appendChild(t);
        let n = document.createElement("div");
        n.style.display = "flex", n.style.alignItems = "center", n.style.justifyContent = "center", n.style.flexDirection = "column", n.style.height = "100%";
        let o = document.createElement("div");
        o.className = "input-group mb-2", o.style.width = "400px";
        let s = document.createElement("input");
        s.type = "text", s.className = "form-control", s.placeholder = "ここにJSONを貼り付け", o.appendChild(s);
        let i = document.createElement("div");
        i.className = "input-group-append";
        let a = document.createElement("button");
        a.className = "btn btn-outline-secondary btn-labeled", a.type = "button", a.innerText = "Download", i.appendChild(a), o.appendChild(i), n.appendChild(o);
        let r = document.createElement("div");
        r.className = "progress mb-3", r.style.width = "400px";
        let l = document.createElement("div");
        l.className = "progress-bar", l.role = "progressbar", l["aria-valuemin"] = "0", l["aria-valuemax"] = "100", l["aria-valuenow"] = "0", l.style.width = "0%", l.innerText = "0%";
        const c = e => {
            l["aria-valuenow"] = `${e}`, l.style.width = `${e}%`, l.innerText = `${e}%`
        };
        ...
        h.className = "form-check-input", h.type = "checkbox", h.id = "LogCheck", h.checked = !0, u.appendChild(h);
        let p = document.createElement("label");
        p.className = "form-check-label", p.for = "LogCheck", p.innerText = "ログを自動スクロール", u.appendChild(p), d.appendChild(u);
        ...
        f.className = "form-control", f.readOnly = !0, f.style.resize = "both", f.style.width = "500px", f.style.height = "80px";
        const b = e => {
            f.value += `${e}\n`, h.checked && (f.scrollTop = f.scrollHeight)
        };
        n.appendChild(f), document.body.appendChild(n);
        let v = document.createElement("script");
        v.src = this.bootJS.src, v.integrity = this.bootJS.integrity, v.crossOrigin = "anonymous", document.body.appendChild(v);
    ...
    async downloadZip(e, t, n, o) {
        ...
        const s = this,
            i = this.utils;
        await i.embedScript("https://cdn.jsdelivr.net/npm/web-streams-polyfill@2.0.2/dist/ponyfill.min.js"), await i.embedScript("https://cdn.jsdelivr.net/npm/streamsaver@2.0.6/StreamSaver.js"), await i.embedScript("https://cdn.jsdelivr.net/npm/streamsaver@2.0.6/examples/zip-stream.js");
        const a = i.encodeFileName(e.id),
            ...
            l = new createWriter({
                async pull(r) {
                    ...
                    n(`@${e.id} 投稿:${e.postCount} ファイル:${e.fileCount}`), d([s.createRootHtmlFromPosts(e)], "index.html");
                    let u = 0;
                    for (const a of e.posts) {
                        n(`${a.originalName} (${++u}/${e.postCount})`);
                        const r = i.createInformationFile(a.informationText);
                        if (d(r.content, `${a.encodedName}/${i.encodeFileName(r.name)}`), d([s.createHtmlFromBody(a.originalName, a.htmlText)], `${a.encodedName}/index.html`), a.cover) {
                        ...
                        for (const s of a.files) {
                            ...
                            r ? d([r], `${a.encodedName}/${s.encodedName}`) : (console.error(`${s.encodedName}(${s.url})のダウンロードに失敗、読み飛ばすよ`), n(`${s.encodedName}のダウンロードに失敗`)), c++, setTimeout((() => {
                                const n = Math.floor(Math.abs(Math.floor(Date.now() / 1e3) - l) * (e.fileCount - c) / c),
                                    s = n / 3600 | 0,
                                    i = Math.ceil((n - 3600 * s) / 60);
                                o(`${s}:${("00"+i).slice(-2)}`), t(100 * c / e.fileCount | 0)
                            }), 0), await i.sleep(1000)//下载每个文件的延时设置为1000ms
                        }
                    }
                    r.close()
                }
            });
        if (window.WritableStream && l.pipeTo) return l.pipeTo(r).then((() => console.log("done writing")));
        const c = r.getWriter(),
            d = l.getReader(),
    ...
    isDownloadJsonObj(e) {
        switch (!0) {
            ...
            case "number" != typeof e.postCount:
                return console.error("ダウンロード用オブジェクトの型が不正(postCountが数値でない)", e.postCount), !1;
            case "number" != typeof e.fileCount:
                return console.error("ダウンロード用オブジェクトの型が不正(fileCountが数値でない)", e.fileCount), !1;
        ...
        return !e.posts.some((t => {
            switch (!0) {
                case "object" != typeof t:
                    return console.error("ダウンロード用オブジェクトの型が不正(postsの値にobjectでないものが含まれる)", t, e.posts), !0;
                case "string" != typeof t.informationText:
                    return console.error("ダウンロード用オブジェクトの型が不正(postsの値にinformationTextが文字列でないものが含まれる)", t.informationText, e.posts), !0;
                case "string" != typeof t.htmlText:
                    return console.error("ダウンロード用オブジェクトの型が不正(postsの値にhtmlTextが文字列でないものが含まれる)", t.htmlText, e.posts), !0;
                case !Array.isArray(t.files):
                    return console.error("ダウンロード用オブジェクトの型が不正(postsの値にfilesが配列でないものが含まれる)", t.files, e.posts), !0;
                case !Array.isArray(t.tags):
                    return console.error("ダウンロード用オブジェクトの型が不正(postsの値にtagsが配列でないものが含まれる)", t.tags, e.posts), !0;
                case t.files.some((n => {
                    var o, s, i, a;
                    switch (!0) {
                        case "object" != typeof n:
                            return console.error("ダウンロード用オブジェクトの型が不正(postsのfilesの値にオブジェクトでないものが含まれる)", n, t.files), !0;
                        case "string" != typeof n.url:
                            return console.error("ダウンロード用オブジェクトの型が不正(postsのfilesの値にurlが文字列でないものが含まれる)", n.url, t.files), !0;
                        case "string" != typeof n.originalName:
                            return console.error("ダウンロード用オブジェクトの型が不正(postsのfilesの値にoriginalNameが文字列でないものが含まれる)", n.originalName, t.files), !0;
                        case "string" != typeof n.encodedName:
                            return console.error("ダウンロード用オブジェクトの型が不正(postsのfilesの値にencodedNameが文字列でないものが含まれる)", n.encodedName, t.files), !0;
                        case void 0 === t.cover:
                            return !1;
                        case "object" != typeof t.cover:
                            return console.error("ダウンロード用オブジェクトの型が不正(postsの値にcoverがobjectでないものが含まれる)", t.cover, e.posts), !0;
                        case "string" != typeof(null === (o = t.cover) || void 0 === o ? void 0 : o.url):
                            return console.error("ダウンロード用オブジェクトの型が不正(postsのcoverの値にurlが文字列でないものが含まれる)", null === (s = t.cover) || void 0 === s ? void 0 : s.url, t.cover), !0;
                        case "string" != typeof(null === (i = t.cover) || void 0 === i ? void 0 : i.name):
                            return console.error("ダウンロード用オブジェクトの型が不正(postsのcoverの値にnameが文字列でないものが含まれる)", null === (a = t.cover) || void 0 === a ? void 0 : a.name, t.cover), !0;
                        default:
                            return !1
                    }
                })):
...
class a {
    constructor(e, t) {
        this.userId = e, this.feeMap = t, this.isIgnoreFree = !1, this.fees = [], this.tags = [], this.isLimitAvailable = !1, this.limit = 0, this.downloadObject = new n(e, a.utils)
    }
    addFee(e) {
    ...
    getTagByFee(e) {
        var t;
        return null !== (t = this.feeMap.get(e)) && void 0 !== t ? t : (e > 0 ? `${e}円` : "無料") + "プラン"
    }
    setLimitAvailable(e) {
...
async function r() {
    var e, t, n, o;
    let s;
    if ("https://downloads.fanbox.cc" === window.location.origin) return void await new i(a.utils).createDownloadUI("fanbox-downloader");
    if ("https://www.fanbox.cc" === window.location.origin) {
        const n = null === (e = window.location.href.match(/fanbox.cc\/@([^\/]*)/)) || void 0 === e ? void 0 : e[1],
            o = null === (t = window.location.href.match(/fanbox.cc\/@.*\/posts\/(\d*)/)) || void 0 === t ? void 0 : t[1];
        s = await l(n, o)
    } else {
        if (!window.location.href.match(/^https:\/\/(.*)\.fanbox\.cc\//)) return void alert(`ここどこですか(${window.location.href})`);
        {
            const e = null === (n = window.location.href.match(/^https:\/\/(.*)\.fanbox\.cc\//)) || void 0 === n ? void 0 : n[1],
                t = null === (o = window.location.href.match(/.*\.fanbox\.cc\/posts\/(\d*)/)) || void 0 === o ? void 0 : o[1];
            s = await l(e, t)
        }
    }
    if (!s) return;
    ...
    console.log(r);
    const c = () => {
        alert("jsonをコピーしました。downloads.fanbox.ccで実行して貼り付けてね"), confirm("downloads.fanbox.ccに遷移する？") && (document.location.href = "https://downloads.fanbox.cc")
    };
    try {
        await navigator.clipboard.writeText(r), c()
    } catch (e) {
        document.body.addEventListener("click", (() => {
            navigator.clipboard.writeText(r).then((() => c())).catch((() => alert("jsonコピーに失敗しました。もう一度実行するかコンソールからコピーしてね")))
        }), {
            once: !0
...
async function l(e, t) {
    ...
    const s = a.utils.httpGetAs(`https://api.fanbox.cc/plan.listCreator?creatorId=${e}`).body,
        i = new Map;
    null == s || s.forEach((e => i.set(e.fee, e.title)));
    const r = new a(e, i);
    r.downloadObject.setUrl(`https://www.fanbox.cc/@${e}`);
    const l = null !== (o = null === (n = a.utils.httpGetAs(`https://api.fanbox.cc/tag.getFeatured?creatorId=${e}`).body) || void 0 === n ? void 0 : n.map((e => e.tag))) && void 0 !== o ? o : [];
    return r.addTags(...l), t ? u(r, d(t)) : await async function(e) {
        ...
        const n = a.utils.httpGetAs(`https://api.fanbox.cc/post.paginateCreator?creatorId=${e.userId}`).body;
        for (let t = 0; t < n.length; t++) console.log(`${t+1}回目`), await c(e, n[t]), await a.utils.sleep(100)
    }(r), r.applyTags(), r.downloadObject
}
async function c(e, t) {
    const n = a.utils.httpGetAs(t).body;
    console.log(`投稿の数:${n.length}`);
    for (const t of n) {
        if (!e.isLimitValid()) break;
        t.body ? u(e, t) : t.isRestricted || (await a.utils.sleep(100), u(e, d(t.id)))
    }
}

function d(e) {
	await a.utils.sleep(700); //此处设置抓去延时700ms
    return a.utils.httpGetAs(`https://api.fanbox.cc/post.info?postId=${e}`).body
}

function u(e, t) {
    if (!t || e.isIgnoreFree && 0 === t.feeRequired) return;
    if (!t.body || t.isRestricted) return void console.log(`取得できませんでした(支援がたりない？)\nfeeRequired: ${t.feeRequired}@${t.id}`);
    const n = t.title,
        o = e.downloadObject.addPost(n);
    o.setTags([e.getTagByFee(t.feeRequired), ...t.tags]), e.addFee(t.feeRequired), e.addTags(...t.tags);
    const s = (e => {
        var t;
        if (e) {
    ...
    switch (t.type) {
        case "image": {
            const e = t.body.images.map((e => o.addFile(n, e.extension, e.originalUrl))).map((e => o.getImageLinkTag(e))).join("<br>\n"),
                a = t.body.text.split("\n").map((e => `<span>${e}</span>`)).join("<br>\n");
            o.setHtml(s + e + "<br>\n" + a), i = `${t.body.text}\n`;
            break
        }
        case "file": {
            const e = t.body.files.map((e => o.addFile(e.name, e.extension, e.url))).map((e => o.getAutoAssignedLinkTag(e))).join("<br>\n"),
                n = t.body.text.split("\n").map((e => `<span>${e}</span>`)).join("<br>\n");
            o.setHtml(s + e + "<br>\n" + n), i = `${t.body.text}\n`;
            break
        }
        case "article": {
            const e = function(e, t) {
                ...
                a = function(e, t) {
                    ...
                    return Object.keys(e).sort(((e, t) => o(e) - o(t))).map((t => e[t]))
                }(t.body.fileMap, t.body.blocks).map((e => o.addFile(e.name, e.extension, e.url))),
                r = function(e, t) {
                ...
                switch (t.type) {
                    ...
                    case "url_embed": {
                        ...
                        switch (e.type) {
                            ...
                            case "html":
                            case "html.card":
                                const t = null === (n = e.html.match(/<iframe.*src="(http.*)"/)) || void 0 === n ? void 0 : n[1];
                                return t ? o.getLinkTag(t, "iframe link") : `\n${e.html}\n\n`;
                            case "fanbox.post":
                                const s = `https://www.fanbox.cc/@${e.postInfo.creatorId}/posts/${e.postInfo.id}`;
...
a.utils = new class {
    constructor() {
        this.audioExtension = /\.(mp3|m4a|ogg)$/, this.imageExtension = /\.(apng|avif|gif|jpg|jpeg|jfif|pjpeg|pjp|png|svg|webp)$/, this.videoExtension = /\.(mp4|webm|ogv)$/
    }
    isAudio(e) {
    ...
    httpGetAs(e) {
        ...
        return t.open("GET", e, !1), t.withCredentials = !0, t.send(null), JSON.parse(t.responseText)
    }
    encodeFileName(e) {
        return e.replace(/\//g, "／").replace(/\\/g, "＼").replace(/,/g, "，").replace(/:/g, "：").replace(/\*/g, "＊").replace(/"/g, "“").replace(/</g, "＜").replace(/>/g, "＞").replace(/\|/g, "｜").trim()
    }
    encodeURI(e) {
        return this.encodeFileName(e).replaceAll(/[;,/?:@&=+$#]/g, encodeURIComponent)
    }
    splitExt(e) {
        return e.split(/(?=\.[^.]+$)/)
    }
    ...
    async fetchWithLimit({
        ...
        try {
            ...
            return console.error(`通信エラー: ${t}, ${e}`), await this.sleep(1e3), await this.fetchWithLimit({
                url: e,
                name: t
            }, n - 1)
        }
    ...
    async embedScript(e) {
        return new Promise(((t, n) => {
            ...
            o.src = e, o.onload = () => t(o), o.onerror = e => n(e), document.head.appendChild(o)
        }))
    }
}, a.isExportJson = !0;
var h = t.D;
